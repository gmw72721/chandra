...
class PdfRagState(TypedDict):
    ...
    support_intents: NotRequired[list[dict[str, Any]]]
    additional_support_intents: NotRequired[list[dict[str, Any]]]
    ready_support_bundle: NotRequired[dict[str, Any]]
    support_bundle_action: NotRequired[dict[str, Any]]
    scheduled_background_jobs: NotRequired[list[dict[str, Any]]]
    search_ledger: NotRequired[list[dict[str, Any]]]
    pending_choice_state: NotRequired[dict[str, Any]]
    primary_background_support_searches: NotRequired[list[dict[str, Any]]]
    context_background_support_searches: NotRequired[list[dict[str, Any]]]
    background_support_searches: NotRequired[list[dict[str, Any]]]
    background_support_prefetch_diagnostics: NotRequired[list[dict[str, Any]]]
    background_support_prefetch_source: NotRequired[str]
    ...
    prior_knowledge_items: NotRequired[list[dict[str, Any]]]
    ...
    reference_expansion_depth: NotRequired[int]
    reference_expansion_diagnostics: NotRequired[list[dict[str, Any]]]
    chat_retrieval_memory: NotRequired[dict[str, Any]]
    chat_retrieval_memory_persisted_hash: NotRequired[str]
    ...
    final_answer_json_parse_cache: NotRequired[dict[str, Any]]
    final_structured_output_cache: NotRequired[dict[str, Any]]
