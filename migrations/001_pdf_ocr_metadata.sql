...
ALTER TABLE pdf_materials
  ...
  ADD COLUMN IF NOT EXISTS professor_id TEXT NOT NULL DEFAULT '',
  ...
  ADD COLUMN IF NOT EXISTS search_metadata_source TEXT NOT NULL DEFAULT 'postgres',
  ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
  ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ NOT NULL DEFAULT now(),
  ADD COLUMN IF NOT EXISTS indexed_at TIMESTAMPTZ NOT NULL DEFAULT now();

ALTER TABLE pdf_pages
  ADD COLUMN IF NOT EXISTS material_id TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS class_id TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS course_id TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS professor_id TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS teacher_id TEXT NOT NULL DEFAULT '',
  ...
  ADD COLUMN IF NOT EXISTS page_start INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS page_end INTEGER NOT NULL DEFAULT 0,
  ...
  ADD COLUMN IF NOT EXISTS text_search TSVECTOR GENERATED ALWAYS AS (to_tsvector('english', coalesce(ocr_text, ''))) STORED,
  ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
  ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ NOT NULL DEFAULT now();
...
ALTER TABLE pdf_detected_problems
  ADD COLUMN IF NOT EXISTS material_id TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS page_id BIGINT NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS class_id TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS course_id TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS professor_id TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS teacher_id TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS title TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS material_type TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS problem_number TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS page_start INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS page_end INTEGER NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS problem_text TEXT NOT NULL DEFAULT '',
  ...
  ADD COLUMN IF NOT EXISTS storage_bucket TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS storage_path TEXT NOT NULL DEFAULT '',
  ADD COLUMN IF NOT EXISTS text_search TSVECTOR GENERATED ALWAYS AS (to_tsvector('english', coalesce(problem_text, ''))) STORED,
  ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ NOT NULL DEFAULT now(),
  ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ NOT NULL DEFAULT now();
